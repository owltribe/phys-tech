    ...
    return (
        <MyStack p="$4">
            <ScrollView mt="$2">
                <YStack space="$3">
                    <Image
                        source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeavdP9LMP2O_5PlsdSSCOM3nbt0fsLjPNVA&usqp=CAU" }}
                        width='100%'
                        height={200}
                ...
                <YStack space="$1" mt="$2">
                    <H2>Описание</H2>
                    <Paragraph size="$5">
                        ТОО «Физико-технический
                        институт» обладает современным
                        оборудованием и специалистами
                        для проведения качественных и
                ...
                <YStack space="$1" mt="$2">
                    <H3>Сервисы</H3>
                    <ScrollView showsHorizontalScrollIndicator={false} horizontal space="$5" mt="$3">
